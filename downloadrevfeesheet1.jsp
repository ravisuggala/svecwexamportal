...
function populateSecValues(obj){
	...
	var urlString ="./feerevregistration2.jsp?course="+course+"&sem="+sem+"&ay="+ay+"&reg="+reg+"&yoa="+yoa+"&type=regular" ;
	...
	<body>
		  <div id="centre">
					    ...
					    <center><h1>Exam Fee Sheet for Revaluation Examination</h1></center>
					    <CENTER>
					    	<TABLE BORDER="1" CELLPADDING="2" CELLSPACING="2" WIDTH="290">
							<FORM NAME = REGISTER METHOD = POST ACTION = "./revfeesheetprogress.jsp">
							<TR>
