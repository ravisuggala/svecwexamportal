...
function populateSecValues(obj){
	...
	var type="Supply Revaluation";
	var urlString ="./revregistration2.jsp?course="+course+"&sem="+sem+"&ay="+ay+"&reg="+reg+"&yoa="+yoa+"&type="+type ;
	...
	<body>
		  <div id="centre">
					    ...
					    <center><h1>Supply Revaluation Examination Registration</h1></center>
					    <CENTER>
