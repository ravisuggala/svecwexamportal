...
function populateSecValues(obj){
	...
	var urlString ="./examnames1.jsp?degree="+degree+"&sem="+sem+"&ay="+elt3+"&reg="+reg+"&yoa="+yoa+"&type=supply" ;
	$.ajax({
	type: "POST",
	url: urlString ,
	...
	<body>
		  <div id="centre">
					    ...
					    <CENTER>
							...
							<FORM NAME = REGISTER METHOD = POST ACTION = "./fesupplyregistration.jsp">
							...
							<select name=yoa id=yoa onchange="populateSecValues(this)">
								<option value=""></option>
