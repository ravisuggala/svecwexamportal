...
<!--
document.writeln("<br><br><br><br><br><br><br><br><br><br><center><h3> Subject Mappings is Deleting....Please Wait..<br></br></h3></center>");
setTimeout("location.href = '././ActionServlet?option=delmapprogress';",150);
-->
</script>
