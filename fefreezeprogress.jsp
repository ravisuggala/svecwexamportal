...
<!--
document.writeln("<br><br><br><br><br><br><center><h3>Free Elective Freeze is going....Please Wait..<br></br></h3></center>");
setTimeout("location.href = '././ActionServlet?option=fefreeze';",150);
-->
</script>
