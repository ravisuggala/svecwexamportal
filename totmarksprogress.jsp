...
<!--
document.writeln("<br><br><br><br><br><br><br><br><br><br><center><h3> Total Marks are Calculating....Please Wait..<br></br></h3></center>");
setTimeout("location.href = '././ActionServlet?option=totmarksprogress';",150);
-->
</script>
