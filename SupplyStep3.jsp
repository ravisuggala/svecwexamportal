...
String sem=miscUtil.noNull(session.getValue("sem").toString());
String examname=miscUtil.noNull(session.getValue("examname").toString());
...
%>
<FORM NAME = REGISTER METHOD = POST ACTION = "./supplysave.jsp">
