...
<jsp:include page='<%= header %>' flush="true" />
	...
	<body>
		  <div id="centre">
					    ...
					    <center><h3>SVECW Website DataSheet Download</h3></center>
					    <CENTER>
					    	<TABLE BORDER="1" CELLPADDING="2" CELLSPACING="2" WIDTH="290">
							<FORM NAME = REGISTER METHOD = POST ACTION = "./websitesheetprogress.jsp">
						...
						<TR>
							...
							<TR>
								...
								<TR>
								<TD  WIDTH="20%" ALIGN="right" nowrap>Result Code </TD>
								<td WIDTH="10%" ALIGN="left"><input maxlength="20" name="rcode"></td>
							</tr>
							<TR>
								<TD  WIDTH="20%" ALIGN="right" nowrap>Revaluation Date</TD>
								<td><input id='demo0' type="text"  size="10" name='revdate'><a href="javascript:NewCal('demo0','ddMMMyyyy')"><img src="./imgs/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a></td>
							</tr>					
        					<TR>
