...
function populateSecValues(obj){
	...
	var urlString ="./regularregistration2.jsp?course="+course+"&sem="+sem+"&ay="+ay+"&reg="+reg+"&yoa="+yoa+"&period="+period ;
	...
	<body>
		  <div id="centre">
					    ...
					    <center><h1>Regular Examination Registration</h1></center>
					    <CENTER>
					    	<TABLE BORDER="1" CELLPADDING="2" CELLSPACING="2" WIDTH="290">
							<FORM NAME = REGISTER METHOD = POST ACTION = "./regularregsimport.jsp">
							<TR>
