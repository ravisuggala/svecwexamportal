...
function validateMarks(field) 
{
	var i;
	 ...
	 var patt1 = new RegExp("^(a|A|[0-9]|1[0-9]|20)$");
...
for(int i=0;i<mapids.size();i++)
{
	...
	MidExam attempted=medb.findMapidinMid20(mapid,type);
	...
	if(attempted==null)
	{
		  if(subject.equals("UGME1T01")||subject.equals("UGME3T06")||subject.equals("UGME2T01")||subject.equals("UGME4T06"))
		 {
		 ...
		 else if(branch.equals("M.B.A"))
		 {
			 dmbox="<input id=dm"+i+" type=text maxlength=2 size=3 name="+mapid+"-dm"+type+"></input>";
			 qmbox="<input id=mm"+i+" type=text maxlength=2 size=3 name="+mapid+"-qm"+type+" ></input>";
			 ambox="<input type=hidden size=3 name="+mapid+"-am"+type+" value=0></input>";	
			 atbox="<input type=hidden size=3 name=h"+mapid+"-"+type+" value=false></input>";
		 }
		 else if(branch.startsWith("MT"))
		 {
			 dmbox="<input id=mt"+i+" type=text maxlength=2 size=3 name="+mapid+"-dm"+type+"></input>";
			 qmbox="<input type=hidden size=3 name="+mapid+"-qm"+type+" value=0></input>";
			 ambox="<input type=hidden size=3 name="+mapid+"-am"+type+" value=0></input>";	
			 atbox="<input type=hidden size=3 name=h"+mapid+"-"+type+" value=false></input>";
		 }
		 else
		 {
			 ...
			 ambox="<input id=am"+i+" type=text maxlength=2 size=3 name="+mapid+"-am"+type+" ></input>";	
			 atbox="<input type=hidden size=3 name=h"+mapid+"-"+type+" value=false></input>";	 
		 }
	...
	else
	{
		 ...
		 {
			 dmbox="<input id=dm"+i+" type=text maxlength=2 size=3 name="+mapid+"-dm"+type+" value="+attempted.getDm()+"></input>";
			 qmbox="<input id=mm"+i+" type=text maxlength=2 size=3 name="+mapid+"-qm"+type+" value="+attempted.getQm()+"></input>";
			 ambox="<input type=hidden size=3 name="+mapid+"-am"+type+" value=0></input>";	
			 atbox="<input type=hidden size=3 name=h"+mapid+"-"+type+" value=true></input>";
		 }
		else if(branch.startsWith("MT"))
		 {
			 dmbox="<input id=mt"+i+" type=text maxlength=2 size=3 name="+mapid+"-dm"+type+" value="+attempted.getDm()+"></input>";
			 qmbox="<input type=hidden size=3 name="+mapid+"-qm"+type+" value=0></input>";
			 ambox="<input type=hidden size=3 name="+mapid+"-am"+type+" value=0></input>";	
			 atbox="<input type=hidden size=3 name=h"+mapid+"-"+type+" value=true></input>";
		 }
		else
		{
			dmbox="<input id=dm"+i+" type=text size=3 maxlength=2 name="+mapid+"-dm"+type+" value="+attempted.getDm()+"></input>";
			 ...
			 ambox="<input id=am"+i+" type=text size=3 maxlength=2 name="+mapid+"-am"+type+" value="+attempted.getAm()+" ></input>";
			 atbox="<input type=hidden size=3 name=h"+mapid+"-"+type+" value=true></input>";
		}
	}
