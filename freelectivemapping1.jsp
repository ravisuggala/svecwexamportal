...
<html>
	...
	<body>
		  <div id="centre">
					    ...
					    <center><h2>Free Elective Mapping </h2></center>
					    <CENTER>
					    	<TABLE BORDER="1" CELLPADDING="2" CELLSPACING="2" WIDTH="290">
							<FORM NAME = REGISTER METHOD = POST ACTION = "./freelectivemapping2.jsp">
							<INPUT TYPE=HIDDEN NAME="hiddenActionType" VALUE = "FreeElectiveMap1">
							...
							<TR>
								<TD  WIDTH="20%" ALIGN="right">Elective Category </TD>
								<td WIDTH="10%" ALIGN="left">
								<select name="fe">
									<option></option>
