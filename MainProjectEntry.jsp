...
function toggle(selectObj) {
	...
	var reg=document.getElementById("reg").value;
		...
		var urlString ="./mpsubject.jsp?degree="+degree+"&branch="+branch+"&sem="+sem+"&reg="+reg ;
		$.ajax({
		type: "POST",
		url: urlString ,
	...
	<body>
		  <div id="centre">
					    ...
					    <center><h1>Main Project Internal Examinations Marks Entry</h1></center>
					    <CENTER>
					    	<TABLE BORDER="1" CELLPADDING="2" CELLSPACING="2" WIDTH="290">
							<FORM NAME = REGISTER METHOD = POST ACTION = "./mpmarksStep2.jsp">
							<INPUT TYPE=HIDDEN NAME="hiddenActionType" VALUE = "mpstep1">
							...
							<TR id="subname">
								<TD  WIDTH="20%" ALIGN="right" nowrap>Name of the Project </TD>
								<td WIDTH="10%" ALIGN="left">
