...
if (session.getAttribute("marksinput")!=null)
{
	 ...
	 out.println("<center><h6>"+status+"</h6></center>");
		%>
		 <jsp:include page='./storecastatus.jsp' flush="true" />
	    <% 
		  ...
		  <div id="centre">
			    ...
			    <CENTER>
						<TABLE BORDER="1" CELLPADDING="2" CELLSPACING="2" WIDTH="300">
							...
							<th nowrap><font size=1>Course Activity-I</font>
							<th nowrap><font size=1>Course Activity-II</font>
							...
							<INPUT TYPE=HIDDEN NAME="option" VALUE = "camarks">
