...
<jsp:include page='<%= header %>' flush="true" />
	...
	<body>
		  <div id="centre">
					    ...
					    <center><h3>Students Deletion</h3></center>
					    <CENTER>
					    	<TABLE BORDER="1" CELLPADDING="2" CELLSPACING="2" WIDTH="290">
							<FORM NAME = REGISTER METHOD = POST ACTION = "./delstprogress.jsp" onsubmit="return confirm('Do you really want to Delete Students Details');">
