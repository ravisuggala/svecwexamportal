...
String selele=session.getValue("fe").toString();

String elesubj=miscUtil.noNull(request.getParameter("elesubj"));
...
<html>
	<head>
		<title>Free Elective Mapping</title>
		  ...
		  <div id="centre">
			    ...
			    <CENTER>
						<TABLE BORDER="1" WIDTH="650" style="table-layout: fixed;">
							<TR>
							    <TD COLSPAN="2" ALIGN="center"><h2><b> Free Elective Mapping Information</b></h2></TD>
							</TR>
							...
							<INPUT TYPE=HIDDEN NAME="option" VALUE = "femap">
