...
if (session.getAttribute("marksinput")!=null)
{
	 ...
	 out.println("<center><h6>"+status+"</h6></center>");
		%>
		 <jsp:include page='./storeassstatus.jsp' flush="true" />
	    <% 
...
for(int i=0;i<mapids.size();i++)
{
	...
	AssignmentMarks attempted=medb.findMapidinAssignment(mapid,sem);
	...
	if(attempted==null)
	{
			 dmbox="<input id=am1"+i+"  type=text maxlength=2 size=3 name="+mapid+"-am1"+"></input>";
			 qmbox="<input id=am2"+i+" type=text maxlength=2 size=3 name="+mapid+"-am2"+" ></input>";
			 ambox="<input id=am3"+i+" type=text maxlength=2 size=3 name="+mapid+"-am3"+" ></input>";	
	...
	else
	{
			...
			dmbox="<input id=am1"+i+" type=text size=3 maxlength=2 name="+mapid+"-am1"+" value="+attempted.getAm1()+"></input>";
			 qmbox="<input id=am2"+i+" type=text size=3 maxlength=2 name="+mapid+"-am2"+" value="+attempted.getAm2()+" ></input>";
			 ambox="<input id=am3"+i+" type=text size=3 maxlength=2 name="+mapid+"-am3"+" value="+attempted.getAm3()+" ></input>";
		  ...
		  <div id="centre">
			    ...
			    <CENTER>
						<TABLE BORDER="1" CELLPADDING="2" CELLSPACING="2" WIDTH="300">
							...
							<th nowrap><font size=1>Assignment-I</font>
							<th nowrap><font size=1>Assignment-II</font>
							<th nowrap><font size=1>Assignment-III</font>
							</tr>
							<%
							...
							<INPUT TYPE=HIDDEN NAME="option" VALUE = "assmarks">
