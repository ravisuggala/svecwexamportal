...
else
{
	...
	reg=ee.getReg();
	HashMap hm=subdb.getElectiveList(degree, branch, sem, ee.getReg());
	if(hm.size()==0)
	{
		String info=eedb.isExisted(code,sem,branch);
		if(info.equals("0"))
		{
	...
	{
		session.putValue("electivelist",hm);
		miscUtil.forwardToPage(request, response,"./subjcategory.jsp");
	}
}
