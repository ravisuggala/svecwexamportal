...
<!--
document.writeln("<br><br><br><br><br><br><center><h3>Consolidated Results Sheet is Preparing....Please Wait..<br></br></h3></center>");
setTimeout("location.href = '././ActionServlet?option=batchsheet';",150);
-->
</script>
