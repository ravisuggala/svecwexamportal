...
//String target=miscUtil.noNull(session.getValue(("target")));
	...
	session.putValue("yoa", yoa);
			...
			ArrayList stlist=fedb.getSupplyStudentList(sem,branch,ee);
						...
						<TABLE BORDER="1"  width=35%>
							...
							<TR>
								    ...
								    <tr>
										...
										<td nowrap ><input type=checkbox name=regdnos value=<%=st.getRegdno()+"#"+st.getSubcode() %> ></input></td>
									</tr>
									<% }
									...
									<input type=hidden name="option" value="fesupplyregistration"></input>					
							<TR>
