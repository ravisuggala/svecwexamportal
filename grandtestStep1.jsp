...
function subjectselect(elecat)
{
	...
	<body>
		  <div id="centre">
					    ...
					    <center><h1>Grand Test Marks Entry</h1></center>
					    <CENTER>
					    	<TABLE BORDER="1" CELLPADDING="2" CELLSPACING="2" WIDTH="290">
							<FORM NAME = REGISTER METHOD = POST ACTION = "./grandtestStep2.jsp">
							<INPUT TYPE=HIDDEN NAME="hiddenActionType" VALUE = "gtstep1">
							...
							<TR>
								...
								<option value="vv">Viva-Voce </option>
