...
ArrayList students=new ArrayList();
	...
	{
		String sm=subdb.isContainsViva(degree,branch,sem,reg);
		if(!sm.equals(""))
    	{
    		session.putValue("subject", sm);
    		session.putValue("type", "V");
    		ArrayList mapids=subdb.getMapIDs(students,sm);
    		session.putValue("mapids", mapids);
    		response.sendRedirect("./vivamarks.jsp");
    	}
    	else
    	{
    		String error="No Viva-voce for selected branch and semester";
